    ...
    grunt.initConfig({
        ...
        ngtemplates: {
            'fluro.audio': {
                cwd: './lib/html',
                src: 'fluro/**/*.html',
                dest: 'dist/fluro.audio-templates.js',
                options: {
                    htmlmin: {
        ...
        ngAnnotate: {
            ...
            app: {
                files: {
                    'dist/fluro.audio.js': ['dist/fluro.audio.js'],
                }
            }
        },
        ...
        uglify: {
            ...
            build: {
                src: [
                    'dist/fluro.audio.js',
                    'dist/fluro.audio-templates.js'
                ],
                dest: 'dist/fluro.audio.min.js'
            }
        }
    });
